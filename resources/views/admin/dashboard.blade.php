                                        ...
                                        <div class="d-flex">
                                            <div class="position-relative mb-2">
                                                <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px"
                                                    style="background-image: url({{ asset('assets/img/dashboard/product-1.jpg') }});">
                                                </div>
                                    ...
                                    <td>
                                        <div class="d-flex mb-2 align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px"
                                                    style="background-image: url({{ asset('assets/img/dashboard/product-2.jpg') }});">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
                                                    <span
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex mb-2 align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px"
                                                    style="background-image: url({{ asset('assets/img/dashboard/product-3.jpg') }});">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
                                                    <span
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex mb-2 align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px"
                                                    style="background-image: url({{ asset('assets/img/dashboard/product-4.jpg') }});">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
                                                    <span
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px"
                                                    style="background-image: url({{ asset('assets/img/dashboard/product-5.jpg') }});">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
                                                    <span
