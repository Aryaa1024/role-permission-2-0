        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                <div class="menu-img online">
                    ...
                    <img src="{{ Auth::user()->profile_pic ? asset('storage/' . Auth::user()->profile_pic) : asset('assets/img/user/profile.jpg') }}"
                        alt="Profile" height="60">
                </div>
                <div class="menu-text d-sm-block d-none w-170px">
                    <span>{{ Auth::user()->email ?? 'admin@portfolio.com' }}</span>
                    {{-- <span class="__cf_email__"
                        data-cfemail="ef9a9c8a9d818e828aaf8e8c8c809a819bc18c8082">[email&#160;protected]
                    </span> --}}
                </div>
            </a>
