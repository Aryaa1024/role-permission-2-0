...
<body>
                            ...
                            <div class="row gx-2">
                                <div class="col-6">
                                    <a href="javascript:;" data-toggle="theme-mode-selector" data-theme-mode="dark"
                                        ...
                                        <div class="img"><img src="{{asset('assets/img/mode/dark.jpg')}}"
                                                class="object-fit-cover" height="76" width="76"
                                                alt="Dark Mode"></div>
                                        <div class="text">Dark</div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="javascript:;" data-toggle="theme-mode-selector"
                                        data-theme-mode="light" class="app-theme-mode-link">
                                        <div class="img"><img src="{{asset('assets/img/mode/light.jpg')}}"
                                                class="object-fit-cover" height="76" width="76"
                                                alt="Light Mode"></div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body p-2">
                            <div class="row gx-2">
                                <div class="col-6">
                                    <a href="#"
                                        class="btn active btn-sm btn-outline-light d-flex align-items-center justify-content-center gap-2 w-100 rounded-0 fw-bold fs-12px"
                                        data-toggle="theme-direction-selector" data-theme-direction="ltr">
                                ...
                                <div class="col-6">
                                    <a href="#"
                                        ...
                                        data-toggle="theme-direction-selector" data-theme-direction="rtl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="app-theme-cover">
                                ...
                                <div class="app-theme-cover-item">
                                    <a href="javascript:;" class="app-theme-cover-link"
                                        style="background-image: url({{asset('assets/img/cover/cover-thumb-6.jpg')}});"
                                ...
                                <div class="app-theme-cover-item">
                                    <a href="javascript:;" class="app-theme-cover-link"
                                        style="background-image: url({{asset('assets/img/cover/cover-thumb-7.jpg')}});"
                                ...
                                <div class="app-theme-cover-item">
                                    <a href="javascript:;" class="app-theme-cover-link"
                                        style="background-image: url({{asset('assets/img/cover/cover-thumb-8.jpg')}});"
                                ...
                                <div class="app-theme-cover-item">
                                    <a href="javascript:;" class="app-theme-cover-link"
                                        style="background-image: url({{asset('assets/img/cover/cover-thumb-9.jpg')}});"
    ...
    {{-- LibPhoneNumber Script --}}
    <script src="https://cdn.jsdelivr.net/npm/libphonenumber-js@1.12.27/bundle/libphonenumber-js.min.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.menu .menu-item').each(function() {
                const linkUrl = $(this).find('.menu-link').prop('href');

                if (linkUrl) {
                    const normalizedLink = linkUrl.split('?')[0].replace(/\/$/, '');
